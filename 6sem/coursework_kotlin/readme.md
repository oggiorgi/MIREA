...
Клиент-серверное Android-приложение «MuseFlow», позволяющее слушать музыку, создавать плейлисты, искать треки по жанрам с использованием современного стека технологий (Kotlin, Compose, Ktor, PostgreSQL).

Особенности приложения:
Сохранность данных: кэширование списка треков для работы в условиях нестабильного интернета.
Многозадачность: фоновое воспроизведение и управление через системную шторку уведомлений.
Персонализация: система авторизации и управление личными плейлистами.
